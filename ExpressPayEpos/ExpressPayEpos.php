...
class ExpressPayEpos extends Simpla
{
	...
	{  
        ...
        $return_url = $this->config->root_url.'/payment/ExpressPayEpos/callback.php?result=payment';//Адрес для перенаправления пользователя в случае успешного создания счёта
        $fail_url   = $this->config->root_url.'/payment/ExpressPayEpos/callback.php?result=fail';//Адрес для перенаправления пользователя в случае неуспешной создания счёта
        /*
